...
Consider GitHub's position today. They have built the dominant platform through genuine value creation over more than a decade. But their incentives are now aligned with platform optimization rather than developer empowerment. They acquired npm directly to integrate it into their ecosystem and remove a potential competitive threat. They built GitHub Actions to increase lock-in for teams already using their platform for source code hosting. Every strategic move makes sense from their position as a public company defending its market position. But it also deepens the moat around their dominant franchise.
