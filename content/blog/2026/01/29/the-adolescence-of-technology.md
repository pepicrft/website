...
## The Anatomy of a Power Position

What makes a platform unassailable? It's never just the product. A power position is a constellation of forces that compound over time:

- **Social graph lock-in**: The network of relationships, contributions, and reputation that lives on the platform
- **Information asymmetry**: Data about users, behavior, and outcomes that only the platform possesses
- **Discovery gatekeeping**: Control over how new projects, products, or people get visibility
- **Switching costs**: The accumulated investment in configurations, integrations, and workflows
- **Narrative control**: The ability to shape what "success" means in an industry

Consider any dominant platform in our industry. Their power isn't in their code—it's in these compounding forces. The code can be replicated. The network effects cannot.
...
The same intellectual honesty applies to power redistribution:

- **You don't know what you don't know**. The incumbent's next move is unpredictable. Market dynamics are complex. User behavior is harder to model than you think.
...
Amodei's answer for AI is "Constitutional AI"—training with high-level principles rather than specific instructions. For challenger technology, the answer is similar: **build principles into the foundation, not just the code.**
...
AI might cause mass unemployment. Power redistribution might cause mass disruption—jobs lost, careers upended, industries transformed. Someone always pays the price of progress.
...
Amodei ends with a claim of optimism: "I believe deeply in our ability to prevail, in humanity's spirit and its nobility, but we must face the situation squarely and without illusions."
...
- **Do users actually want agency?** Or do they prefer convenience and the illusion of safety?
- **What happens when the transition completes?** Is there a stable end state, or is constant disruption the new normal?
- **Who pays for the transition?** The incumbent? The challenger? Users? Society?
...
Amodei opens with a scene from Carl Sagan's *Contact*. The astronomer is asked what question she'd pose to aliens. Her answer: *"How did you do it? How did you evolve, how did you survive this technological adolescence without destroying yourself?"*
