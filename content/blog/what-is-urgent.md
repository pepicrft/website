...
I sometimes feel as if a concurrent world of urgencies were competing for my parallel mental processing. For non-tech-savvy people, concurrency and parallelism [are not the same thing](https://www.geeksforgeeks.org/difference-between-concurrency-and-parallelism/). I jump from one thing to another, considering everything urgent, and ending up exhausted at the end of the day. I think it's normal, considering those jumps are sometimes between non-related domains.
