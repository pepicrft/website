...
description = "If you've worked in the Javascript ecosystem, you might already be familiar with the &quot;delete node_modules&quot; solution commonly suggested on StackOverflow and GitHub Issues. People make fun of it, but it's a frustrating scenario that…"
tags = ["js", "open-source", "tooling"]
published_at = "2022-05-06T12:00:00+00:00"
+++

If you've worked in the Javascript ecosystem, you might already be familiar with the *"delete node\_modules"* solution commonly suggested on [StackOverflow](https://stackoverflow.com/) and GitHub Issues. People make fun of it, but it's a frustrating scenario that ruins the developer's experience using a tool or a framework.
...
Every tiny detail can have a significant impact on the developers' experience. Therefore we can't embrace "delete node\_modules" as it is what it is when there are strategies we can adopt to minimize it.
