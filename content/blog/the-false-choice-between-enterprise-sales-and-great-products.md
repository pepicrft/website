+++
title = "The False Choice Between Enterprise Sales and Great Products"
date = 2025-09-20T08:13:50+00:00
slug = "the-false-choice-between-enterprise-sales-and-great-products"
description = "Have you ever avoided using a product because its enterprise-first, sales-driven approach compromised every aspect of the user experience? This has happened to me countless times, and I always wondered if striking a balance would be difficu…"
+++
Have you ever avoided using a product because its enterprise-first, sales-driven approach compromised every aspect of the user experience? This has happened to me countless times, and I always wondered if striking a balance would be difficult. But the more we invest in shaping [Tuist](https://tuist.dev), the more I realize that **marketing and selling to large enterprises doesn't have to conflict** with creating a great product—despite what many B2B companies seem to believe.
