...
At Tuist, we want to set a precedent in the Apple developer tooling space. Too often, closed-source and proprietary solutions emerge, plastering "contact sales" buttons on their websites and finding shady ways to lock developers into their ecosystems. But it doesn’t have to be this way.
