...
date = 2015-05-25T12:00:00+00:00
slug = "full-control-in-your-hybrid-mobile-apps-with-a-local-server"
...
* We can force an update that fixes an important bug introduced in a previous version. - Also force a version that includes assets related to a campaign that we have to launch. - We can force an update to a particular user which might have problems with the app.
...
* **GCDWebServer:** <https://github.com/swisspol/GCDWebServer> - **NanoHTTPD:** <https://github.com/NanoHttpd/nanohttpd>

**Note:** If you also are working on an hybrid app and you're looking for a similar approach you can reach me at [pepi@8fit.com](mailto:pepi@8fit.com). I'll pleased to help you.
