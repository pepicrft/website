...
date = 2015-10-14T12:00:00+00:00
slug = "implementing-a-reactive-collection-property"
...
```
lazy var avatarImageWithBadge: MutableProperty = {
...
```
let property: MutableCollectionProperty = MutableCollectionProperty(["test1", "test2"])
...
> If you found any bug or you would like to comment something about Reactive or this port in particular, feel free to drop me a line, [pedropb@hey.com](mailto:pedropb@hey.com). We're using this an another Reactive concepts on [GitDo](www.gitdo.io)
